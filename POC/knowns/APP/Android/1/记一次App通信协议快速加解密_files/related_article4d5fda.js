...
function r(e){
L=!0,e&&(C.style.display=""),H.style.display="none",S.style.display="none";
}
function a(e){
var t=arguments.length<=1||void 0===arguments[1]?0:arguments[1],n=arguments.length<=2||void 0===arguments[2]?R:arguments[2];
p({
...
var a=function(){
if(o&&o.base_resp&&1*o.base_resp.ret===0)if(Q=o.article_size||0,0===o.list.length)O?r(0!==t):f.addClass(T,"hide");else{
...
O?(o.list.length<n||o.article_size<=t+n)&&r(0!==t):o.article_size===n?(U=!1,f.addClass(T,"hide")):o.article_size>n&&(U=!0,
...
var i=e.getAttribute("data-url"),n=e.getAttribute("data-time"),s=e.getAttribute("data-recalltype"),o=e.getAttribute("data-isreaded");
...
Q>1&&1*T.getAttribute("data-hasreport")!==1&&T.clientHeight+T.offsetTop>=i+T.clientHeight/2&&T.clientHeight+T.offsetTop<=i+T.clientHeight/2+y.getInnerHeight()&&!function(e){
...
function l(){
n(),o(!0),q+=R,a(function(e,t){
o(!1),"sucess"===e&&t();
},q);
}
function c(){
g.on(B,"click",".js_related_item",function(e){
var t=e.delegatedTarget,i=t.getAttribute("data-url"),n=t.getAttribute("data-time"),s=t.getAttribute("data-recalltype"),o=t.getAttribute("data-isreaded"),r=(1*t.getAttribute("data-idx")||0)+1;
...
Isreaded:1*o,
Mmversion:P
},W)),z.isWechat?w.openUrlWithExtraWebview(i):window.open(i);
...
},!1),g.on(window,"scroll",d),O&&(g.on(S,"click",l),g.on(M,"click",function(){
M.style.display="none",l();
})),v.init({
container:B,
biz:window.biz,
mid:window.mid,
...
1===B.children.length&&(O&&!L?(S.style.display="none",M.style.display=""):!O&&U?(B.style.display="none",
...
e("biz_common/utils/string/html.js");
var m=e("biz_common/tmpl.js"),p=e("biz_wap/utils/ajax.js"),u=e("biz_wap/jsapi/core.js"),_=e("appmsg/related_article_tpl.html.js"),w=e("biz_wap/utils/openUrl.js"),g=e("biz_common/dom/event.js"),y=e("common/utils.js"),f=e("biz_common/dom/class.js"),b=e("biz_common/utils/url/parse.js"),j=e("appmsg/i18n.js"),h=e("common/comm_report.js"),v=e("appmsg/related_article_feedback.js"),z=e("biz_wap/utils/mmversion.js"),I=e("biz_wap/utils/device.js"),x=e("appmsg/set_font_size.js").setFontSize,A=e("biz_wap/utils/jsmonitor_report.js"),E=document.getElementById("js_related_area"),B=document.getElementById("js_related"),T=document.getElementById("js_related_load_more"),k=document.getElementById("js_more_article"),S=document.getElementById("js_related_load_more_pc"),H=document.getElementById("js_related_loading_pc"),M=document.getElementById("js_more_article_pc"),C=document.getElementById("js_related_all_pc"),O=I.os.ipad||!z.isIOS&&!z.isAndroid,P=0;
z.isIOS?P=1:z.isAndroid&&(P=2);
var Q=0,U=!1,W={
Bizuin_from:window.biz,
Msgid_from:window.parseInt(window.mid,10)||0,
Itemidx_from:window.parseInt(window.idx,10)||0,
...
R=O?3:1===window.relatedArticleFlag?3:1;
var L=!1,q=0;
return O&&(document.getElementById("js_related_opr").style.display="none",document.getElementById("js_related_opr_pc").style.display=""),
c(),a;
});