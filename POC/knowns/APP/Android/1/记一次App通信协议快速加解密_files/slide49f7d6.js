...
var t,i=this.container,o=this,n=this.video;
setTimeout(function(){
try{
o.__continueSec&&(o.__replaySec=o.__continueSec,o.__continueSec=null),o._jsapiLog("set continue:"+o.__replaySec),
t=n.play(),"object"===("undefined"==typeof t?"undefined":_typeof(t))?t.then(function(){
e(o,i);
}).catch(function(e){
...
var e=this.opt.duration;
if(e&&e>0&&this.container.find(".js_video_length").html(E(e)).show(),1==this.__iosPreloadPause){
var t=this;
setTimeout(function(){
